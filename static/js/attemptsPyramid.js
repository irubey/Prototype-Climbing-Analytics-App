document.addEventListener("DOMContentLoaded", function() {
    ...
    function attemptsVizChart(targetId ,inputData, binnedCodeDict){
        ...
        function createAttemptsVisualization(targetId, inputData, binnedCodeDict) {
            ...
            var averages = computeDataAverages(filteredData);
    ...
    d3.selectAll("input[name='performance-pyramid-discipline-filter']").on('change', updateAttemptsVisualization);
    d3.selectAll("input[name='performance-pyramid-time-filter']").on('change', updateAttemptsVisualization);
